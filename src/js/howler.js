// howler.js extracted from original airma.sh engine.js
...
e.prototype = {
    ...
    volume: function(e) {
        var n = this || t;
        if (e = parseFloat(e), n.ctx || u(), void 0 !== e && e >= 0 && e <= 1) {
    ...
    mute: function(e) {
        var n = this || t;
        n.ctx || u(), n._muted = e, n.usingWebAudio && (n.masterGain.gain.value = e ? 0 : n._volume);
        for (var r = 0; r < n._howls.length; r++)
            if (!n._howls[r]._webAudio)
                for (var i = n._howls[r]._getSoundIds(), o = 0; o < i.length; o++) {
                    var s = n._howls[r]._soundById(i[o]);
...
n.prototype = {
    ...
    load: function() {
        ...
        if (t.noAudio) this._emit("loaderror", null, "No audio support.");
            ...
            for (var n = 0; n < this._src.length; n++) {
                var i, s;
                if (this._format && this._format[n]) i = this._format[n];
                else {
                ...
                if (i || console.warn('No file extension was found. Consider using the "format" property or specify an extension.'), i && t.codecs(i)) {
                    e = this._src[n];
                    break
                }
            }
            if (e) return this._src = e, this._state = "loading", "https:" === window.location.protocol && "http:" === e.slice(0, 5) && (this._html5 = !0, this._webAudio = !1), new r(this), this._webAudio && o(this), this;
    ...
    play: function(e, n) {
        ...
        if ("number" == typeof e) i = e, e = null;
            ...
            if (void 0 === e) {
                e = "__default";
                for (var o = 0, s = 0; s < r._sounds.length; s++) r._sounds[s]._paused && !r._sounds[s]._ended && (o++, i = r._sounds[s]._id);
                1 === o ? e = null : i = null
            }
        }
        var a = i ? r._soundById(i) : r._inactiveSound();
        if (!a) return null;
        if (i && !e && (e = a._sprite || "__default"), "loaded" !== r._state) {
        ...
        if (i && !a._paused) return n || setTimeout(function() {
            r._emit("play", a._id)
        }, 0), a._id;
        ...
        a._paused = !1, a._ended = !1, a._sprite = e, a._seek = u, a._start = r._sprite[e][0] / 1e3, a._stop = (r._sprite[e][0] + r._sprite[e][1]) / 1e3, a._loop = !(!a._loop && !r._sprite[e][2]);
        var d = a._node;
        if (r._webAudio) {
            var p = function() {
                r._refreshBuffer(a);
                var e = a._muted || r._muted ? 0 : a._volume;
                d.gain.setValueAtTime(e, t.ctx.currentTime), a._playStart = t.ctx.currentTime, void 0 === d.bufferSource.start ? a._loop ? d.bufferSource.noteGrainOn(0, u, 86400) : d.bufferSource.noteGrainOn(0, u, c) : a._loop ? d.bufferSource.start(0, u, 86400) : d.bufferSource.start(0, u, c), h !== 1 / 0 && (r._endTimers[a._id] = setTimeout(r._ended.bind(r, a), h)), n || setTimeout(function() {
                    r._emit("play", a._id)
                }, 0)
            };
            "running" === t.state ? p() : (r.once("resume", p), r._clearTimer(a._id))
        } else {
            var f = function() {
                    d.currentTime = u, d.muted = a._muted || r._muted || t._muted || d.muted, d.volume = a._volume * t.volume(), d.playbackRate = a._rate;
                    try {
                        if (d.play(), d.paused) return void r._emit("playerror", a._id, "Playback was unable to start. This is most commonly an issue on mobile devices where playback was not within a user interaction.");
                        h !== 1 / 0 && (r._endTimers[a._id] = setTimeout(r._ended.bind(r, a), h)), n || r._emit("play", a._id)
                    } catch (e) {
                        r._emit("playerror", a._id, e)
                    }
                },
                g = window && window.ejecta || !d.readyState && t._navigator.isCocoonJS;
            if (4 === d.readyState || g) f();
            else {
                var m = function() {
                    f(), d.removeEventListener(t._canPlayEvent, m, !1)
                };
                d.addEventListener(t._canPlayEvent, m, !1), r._clearTimer(a._id)
            }
        }
        return a._id
    },
    ...
    stop: function(e, t) {
        ...
        for (var r = n._getSoundIds(e), i = 0; i < r.length; i++) {
            ...
            o && (o._seek = o._start || 0, o._rateSeek = 0, o._paused = !0, o._ended = !0, n._stopFade(r[i]), o._node && (n._webAudio ? o._node.bufferSource && (void 0 === o._node.bufferSource.stop ? o._node.bufferSource.noteOff(0) : o._node.bufferSource.stop(0), o._panner && (o._panner.disconnect(), o._panner = null), n._cleanBuffer(o._node)) : isNaN(o._node.duration) && o._node.duration !== 1 / 0 || (o._node.currentTime = o._start || 0, o._node.pause())), t || n._emit("stop", o._id))
        }
        return n
    },
    mute: function(e, n) {
    ...
    volume: function() {
        ...
        } else i.length >= 2 && (e = parseFloat(i[0]), n = parseInt(i[1], 10));
        var o;
        ...
        for (var s = 0; s < n.length; s++)(o = r._soundById(n[s])) && (o._volume = e, i[2] || r._stopFade(n[s]), r._webAudio && o._node && !o._muted ? o._node.gain.setValueAtTime(e, t.ctx.currentTime) : o._node && !o._muted && (o._node.volume = e * t.volume()), r._emit("volume", o._id));
        return r
    },
    fade: function(e, n, r, i, o) {
        ...
        for (var a = s._getSoundIds(i), l = 0; l < a.length; l++) {
            ...
            if (u && (i || s._stopFade(a[l]), s._webAudio && !u._muted)) {
                var c = t.ctx.currentTime,
                    h = c + r / 1e3;
                u._volume = e, null == o && u._node.gain.setValueAtTime(e, c), u._node.gain.linearRampToValueAtTime(n, h)
            }
        }
        return s
    },
    _startFadeInterval: function(e, t, n, r, i) {
        var o = this,
            ...
            l = Math.abs(t - n) / .01,
            u = l > 0 ? r / l : r;
        u < 4 && (l = Math.ceil(l / (4 / u)), u = 4), e._interval = setInterval(function() {
            l > 0 && (s += "in" === a ? .01 : -.01), s = Math.max(0, s), s = Math.min(1, s), s = Math.round(100 * s) / 100, o._webAudio ? (void 0 === i && (o._volume = s), e._volume = s) : o.volume(s, e._id, !0), (n < t && s <= n || n > t && s >= n) && (clearInterval(e._interval), e._interval = null, o.volume(n, e._id), o._emit("fade", e._id))
        }, u)
    },
    ...
    rate: function() {
        ...
        for (var s = 0; s < n.length; s++)
            if (o = r._soundById(n[s])) {
                o._rateSeek = r.seek(n[s]), o._playStart = r._webAudio ? t.ctx.currentTime : o._playStart, o._rate = e, r._webAudio && o._node && o._node.bufferSource ? o._node.bufferSource.playbackRate.value = e : o._node && (o._node.playbackRate = e);
                var a = r.seek(n[s]),
                    l = 1e3 * ((r._sprite[o._sprite][0] + r._sprite[o._sprite][1]) / 1e3 - a) / Math.abs(o._rate);
                !r._endTimers[n[s]] && o._paused || (r._clearTimer(n[s]), r._endTimers[n[s]] = setTimeout(r._ended.bind(r, o), l)), r._emit("rate", o._id)
            } return r
    },
    seek: function() {
        var e, n, r = this,
        ...
        if (0 === i.length) n = r._sounds[0]._id;
            ...
            r._getSoundIds().indexOf(i[0]) >= 0 ? n = parseInt(i[0], 10) : r._sounds.length && (n = r._sounds[0]._id, e = parseFloat(i[0]))
        } else 2 === i.length && (e = parseFloat(i[0]), n = parseInt(i[1], 10));
        ...
        if (o) {
            ...
            var l = r.playing(n);
            l && r.pause(n, !0), o._seek = e, o._ended = !1, r._clearTimer(n), l && r.play(n, !0), !r._webAudio && o._node && (o._node.currentTime = e), r._emit("seek", n)
        }
        return r
    },
    playing: function(e) {
    ...
    unload: function() {
        for (var e = this, n = e._sounds, r = 0; r < n.length; r++) {
            if (n[r]._paused || e.stop(n[r]._id), !e._webAudio) {
                /MSIE |Trident\//.test(t._navigator && t._navigator.userAgent) || (n[r]._node.src = "data:audio/wav;base64,UklGRigAAABXQVZFZm10IBIAAAABAAEARKwAAIhYAQACABAAAABkYXRhAgAAAAEA"), n[r]._node.removeEventListener("error", n[r]._errorFn, !1), n[r]._node.removeEventListener(t._canPlayEvent, n[r]._loadFn, !1)
            }
        ...
        for (r = 0; r < t._howls.length; r++)
            if (t._howls[r]._src === e._src) {
                s = !1;
                break
            } return i && s && delete i[e._src], t.noAudio = !1, e._state = "unloaded", e._sounds = [], e = null, null
    },
    on: function(e, t, n, r) {
        var i = this["_on" + e];
    ...
    off: function(e, t, n) {
        ...
        if ("number" == typeof t && (n = t, t = null), t || n)
            for (i = 0; i < r.length; i++) {
                ...
                for (i = 0; i < s.length; i++) 0 === s[i].indexOf("_on") && Array.isArray(this[s[i]]) && (this[s[i]] = [])
            } return this
    },
    once: function(e, t, n) {
    ...
    _ended: function(e) {
        var n = e._sprite;
        if (!this._webAudio && e._node && !e._node.paused) return setTimeout(this._ended.bind(this, e), 100), this;
        var r = !(!e._loop && !this._sprite[n][2]);
        if (this._emit("end", e._id), !this._webAudio && r && this.stop(e._id, !0).play(e._id), this._webAudio && r) {
        ...
        return this._webAudio && !r && (e._paused = !0, e._ended = !0, e._seek = e._start || 0, e._rateSeek = 0, this._clearTimer(e._id), this._cleanBuffer(e._node), t._autoSuspend()), this._webAudio || r || this.stop(e._id), this
    },
    ...
    _refreshBuffer: function(e) {
        return e._node.bufferSource = t.ctx.createBufferSource(), e._node.bufferSource.buffer = i[this._src], e._panner ? e._node.bufferSource.connect(e._panner) : e._node.bufferSource.connect(e._node), e._node.bufferSource.loop = e._loop, e._loop && (e._node.bufferSource.loopStart = e._start || 0, e._node.bufferSource.loopEnd = e._stop), e._node.bufferSource.playbackRate.value = e._rate, this
    },
...
var i = {},
    o = function(e) {
        var t = e._src;
        if (i[t]) return e._duration = i[t].duration, void l(e);
        if (/^data:[^;]+;base64,/.test(t)) {
            for (var n = atob(t.split(",")[1]), r = new Uint8Array(n.length), o = 0; o < n.length; ++o) r[o] = n.charCodeAt(o);
            a(r.buffer, e)
        } else {
            var u = new XMLHttpRequest;
            u.open("GET", t, !0), u.withCredentials = e._xhrWithCredentials, u.responseType = "arraybuffer", u.onload = function() {
                var t = (u.status + "")[0];
    ...
    a = function(e, n) {
        t.ctx.decodeAudioData(e, function(e) {
            e && n._sounds.length > 0 && (i[n._src] = e, l(n, e))
        }, function() {
...
HowlerGlobal.prototype._pos = [0, 0, 0], HowlerGlobal.prototype._orientation = [0, 0, -1, 0, 1, 0], HowlerGlobal.prototype.stereo = function(e) {
    ...
    return t = "number" != typeof t ? s[1] : t, n = "number" != typeof n ? s[2] : n, r = "number" != typeof r ? s[3] : r, i = "number" != typeof i ? s[4] : i, o = "number" != typeof o ? s[5] : o, "number" != typeof e ? s : (this._orientation = [e, t, n, r, i, o], this.ctx.listener.setOrientation(e, t, n, r, i, o), this)
    ...
    for (var o = r._getSoundIds(n), s = 0; s < o.length; s++) {
        ...
        if (a) {
            ...
            a._stereo = t, a._pos = [t, 0, 0], a._node && (a._pannerAttr.panningModel = "equalpower", a._panner && a._panner.pan || e(a, i), "spatial" === i ? a._panner.setPosition(t, 0, Math.abs(1 - t)) : a._panner.pan.value = t), r._emit("stereo", a._id)
        }
    }
    return r
    ...
    for (var s = o._getSoundIds(i), a = 0; a < s.length; a++) {
        ...
        if (l) {
            ...
            l._pos = [t, n, r], l._node && (l._panner && !l._panner.pan || e(l, "spatial"), l._panner.setPosition(t, n, r)), o._emit("pos", l._id)
        }
    }
    return o
    ...
    for (var s = o._getSoundIds(i), a = 0; a < s.length; a++) {
        ...
        if (l) {
            ...
            l._orientation = [t, n, r], l._node && (l._panner || (l._pos || (l._pos = o._pos || [0, 0, -.5]), e(l, "spatial")), l._panner.setOrientation(t, n, r)), o._emit("orientation", l._id)
        }
    }
    return o
    ...
    for (var o = this._getSoundIds(n), s = 0; s < o.length; s++)
        if (r = this._soundById(o[s])) {
            ...
            var l = r._panner;
            l ? (l.coneInnerAngle = a.coneInnerAngle, l.coneOuterAngle = a.coneOuterAngle, l.coneOuterGain = a.coneOuterGain, l.distanceModel = a.distanceModel, l.maxDistance = a.maxDistance, l.refDistance = a.refDistance, l.rolloffFactor = a.rolloffFactor, l.panningModel = a.panningModel) : (r._pos || (r._pos = this._pos || [0, 0, -.5]), e(r, "spatial"))
        } return this
...
var e = function(e, t) {
    "spatial" === (t = t || "spatial") ? (e._panner = Howler.ctx.createPanner(), e._panner.coneInnerAngle = e._pannerAttr.coneInnerAngle, e._panner.coneOuterAngle = e._pannerAttr.coneOuterAngle, e._panner.coneOuterGain = e._pannerAttr.coneOuterGain, e._panner.distanceModel = e._pannerAttr.distanceModel, e._panner.maxDistance = e._pannerAttr.maxDistance, e._panner.refDistance = e._pannerAttr.refDistance, e._panner.rolloffFactor = e._pannerAttr.rolloffFactor, e._panner.panningModel = e._pannerAttr.panningModel, e._panner.setOrientation(e._orientation[0], e._orientation[1], e._orientation[2])) : (e._panner = Howler.ctx.createStereoPanner(), e._panner.pan.value = e._stereo), e._panner.connect(e._node), e._paused || e._parent.pause(e._id, !0).play(e._id)
}